...
<body>
	...
	<div class="page-container" id="about-container">
		<div class="content" id="about-content">
			...
			<p>To use it, simply create an account, click the category you wish to choose from, and begin building a list of items you're trying to choose from or routinely find yourself indecisive about. You can also view, edit, or delete items on these lists (excluding the random category).</p>
