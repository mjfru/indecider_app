...
<body>
	...
	<div class="page-container" id="about-container">
		<div class="content" id="about-content">
			...
			<p>To use it, create an account, select the category, and begin building a list of items from which to choose or about which you routinely find yourself indecisive. You can also view, edit, or delete items on these lists (excluding the random category).</p>
